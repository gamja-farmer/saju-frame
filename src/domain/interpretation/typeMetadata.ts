...
const TYPE_METADATA_KO: Record<SajuType, TypeMetadata> = {
  'mu-huo-zhi-ren': {
    ...
    favorableGod: '수·금',
    favorableGodDesc: '수는 과열을 막아주고, 금은 방향을 다듬어 열정 속에서 절제를 유지하게 돕습니다',
  ...
  'jin-shui-zhi-ren': {
    ...
    favorableGod: '목·화',
    favorableGodDesc: '목은 에너지를 밖으로 이끌고, 화는 지나치게 냉철한 내면을 따뜻하게 해 표현력을 돕습니다',
  ...
  'tu-jin-zhi-ren': {
    ...
    favorableGod: '목·수',
    favorableGodDesc: '목은 고정된 구조를 느슨하게 하고, 수는 유연함을 더해 건실함 속 탄력을 유지하게 합니다',
  ...
  'shui-mu-zhi-ren': {
    ...
    favorableGod: '화·토',
    favorableGodDesc: '화는 방향에 초점을 주고, 토는 안정된 토대를 마련해 유동 속에서 균형점을 찾게 합니다',
  ...
  'huo-tu-zhi-ren': {
    ...
    favorableGod: '금·수',
    favorableGodDesc: '금은 과한 헌신을 정리하고, 수는 식혀 고갈을 막아 남을 돌보는 동안 자신도 챙기게 합니다',
  ...
  'mu-jin-zhi-ren': {
    ...
    favorableGod: '수·화',
    favorableGodDesc: '수는 성장 에너지를 불려주고, 화는 목금 간 긴장을 풀어 확장과 수렴을 매끄럽게 합니다',
  ...
  'jin-mu-zhi-ren': {
    ...
    favorableGod: '수·토',
    favorableGodDesc: '수는 금목 사이를 잇고, 토는 기반을 단단히 해 구조에 온기를 더합니다',
  ...
  'shui-huo-zhi-ren': {
    ...
    favorableGod: '목·토',
    favorableGodDesc: '목은 수화 에너지가 표출되게 하고, 토는 안정된 그릇이 되어 내면 세계가 담길 공간을 제공합니다',
  ...
  'huo-jin-zhi-ren': {
    ...
    favorableGod: '토·수',
    favorableGodDesc: '토는 화금 충돌을 완충하고, 수는 식혀 주어 질주 후 회복할 여유를 줍니다',
  ...
  'tu-shui-zhi-ren': {
    ...
    favorableGod: '화·금',
    favorableGodDesc: '화는 에너지에 온기와 동력을 주고, 금은 생각을 행동으로 바꾸어 내면의 풍요를 드러내게 합니다',
